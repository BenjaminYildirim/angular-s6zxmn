...
export const tasks: ITask[] = [
  {
    uuid: 'abc',
    title: 'Grossaufgabe mit Unteraufgaben',
    description: 'Unteraufgaben mit dem Pfeil ganz links ausklappen',
    parentTaskUuid: null,
  },
  {
    uuid: 'abcde',
    title: 'Unteraufgabe 1',
    description: 'asdf puelkjr',
    parentTaskUuid: 'abc',
  },
  {
    uuid: 'abcdefg',
    title: 'Unteraufgabe 2',
    description: 'asdf ölkjiueiru sfd',
    parentTaskUuid: 'abc',
  },
];
